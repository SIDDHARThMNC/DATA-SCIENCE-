...
print("University AI-Powered Academic Tool")
print("=" * 65)
...
warn that without immediate action, global temperatures could rise by 3°C by 2100, 
...
class SimpleLLM:
    """Simulates LLM API (Gemini/OpenAI/HuggingFace style)"""
...
def simple_tokenizer(text):
    """Simulates HuggingFace BERT-style tokenizer"""
    # Clean text
